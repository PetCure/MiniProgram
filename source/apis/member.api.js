...
export class MemberApi {
  ...
  //更新个人的地理位置
  addfriend(json, callback, showLoading = true) {
    ...
    console.log(header);
    wx.request({
      url: ApiConfig.GetApiUrl() + 'member/addfriend',
      data: json,
      method: 'POST',
      dataType: 'json',
      header: header,
  ...
  //更新个人的地理位置
  removefriend(json, callback, showLoading = true) {
    ...
    console.log(header);
    wx.request({
      url: ApiConfig.GetApiUrl() + 'member/removefriend',
      data: json,
      method: 'POST',
      dataType: 'json',
      header: header,
  ...
  //更新个人的地理位置
  fanslist(json, callback, showLoading = true) {
    ...
    console.log(header);
    wx.request({
      url: ApiConfig.GetApiUrl() + 'member/fanslist',
      data: json,
      method: 'POST',
      dataType: 'json',
      header: header,
